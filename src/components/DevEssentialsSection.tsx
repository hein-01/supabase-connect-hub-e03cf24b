...
const issueOptions = [
  { id: 'no-free-trial', label: 'No free trial anymore' },
  { id: 'no-free-credits', label: 'No free credits anymore' },
  { id: 'limits-reduced', label: 'Limits reduced' },
  { id: 'link-broken', label: 'Website Link broken' },
];
...
export function DevEssentialsSection() {
  ...
  const handleOpenModal = (e: React.MouseEvent, tool: typeof devTools[0]) => {
    e.preventDefault();
    e.stopPropagation();
